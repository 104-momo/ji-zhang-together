...
const KEYWORDS: Array<[Category, string[]]> = [
  ...
  [
    '日用',
    ['纸巾', '抽纸', '卷纸', '卫生纸', '面巾纸', '湿巾', '洗衣液', '洗衣粉', '洗衣凝珠', '洗发水', '洗发露', '沐浴露', '护发素', '牙膏', '牙刷', '毛巾', '浴巾', '香皂', '肥皂', '垃圾袋', '洗洁精', '清洁剂', '洁厕', '消毒液', '拖把', '扫帚', '扫把', '抹布', '衣架', '收纳', '卫生巾', '纸尿裤', '洗面奶', '洁面', '洗面', '洗脸', '日用品', '日用', '百货', '洗漱'],
  ],
  [
    '购物',
    ['超市', '淘宝', '京东', '拼多多', '衣服', '鞋', '化妆品', '手机', '耳机', '文具', '家电', '商场', '便利店', '买'],
  ],
